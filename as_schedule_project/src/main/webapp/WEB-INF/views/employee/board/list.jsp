...
<%@ include file="/WEB-INF/views/include/nav.jsp" %>
    ...
    <form action="/employee/board/list" id="search_form" method="get">
    	<div class="pagenum">
        	...
        	<c:if test="${not empty list }" >
	        	<c:forEach items="${list}" var="board">
	          	<tr>
					...
					<td><a href="/employee/board/get?bno=${board.bno}">${board.title}</a></td>
      ...
      <div style="text-align:center; margin-top: 20px;">
			<ul class="pull-right">
				<c:if test="${pageMaker.prev}">
					<li>
						<a href="/employee/board/list?pageNum=${pageMaker.startPage -1}
				...
				<c:forEach var="num" begin="${pageMaker.startPage }" end="${pageMaker.endPage }">
				  <li id="numPaging" 
				    ...
				    <a href="/employee/board/list?pageNum=${num}
				      &amount=${pageMaker.cri.amount}&type=${pageMaker.cri.type}
				...
				<c:if test="${pageMaker.next}">
					<li>
						<a href="/employee/board/list?pageNum=${pageMaker.endPage +1}
						&amount=${pageMaker.cri.amount}&type=${pageMaker.cri.type}
